...
class SimpleClassifier(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim1, hidden_dim2, output_dim): # 层的个数 和 验证集精度
        ...
        self.relu1 = nn.ReLU()
        self.fc2 = nn.Linear(hidden_dim1, hidden_dim2) # 调整后
        self.relu2 = nn.ReLU() # 调整后
        self.fc3 = nn.Linear(hidden_dim2, output_dim) # 调整后
